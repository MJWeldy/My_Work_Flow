...
```{r, echo=FALSE, fig.align='center', fig.cap = "This is what many of our folder directories look like. Source: Piled Higher and Deeper by Jorge Cham on www.phdcomics.com."}
library(knitr)
include_graphics("Images/final_doc.JPG")
```
